...
set CLASSPATH=%APP_HOME%\lib\examples.jar;%APP_HOME%\lib\java-gtk.jar;%APP_HOME%\lib\jsr305-3.0.2.jar;%APP_HOME%\lib\jna-5.13.0.jar


@rem Execute examples
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %EXAMPLES_OPTS%  -classpath "%CLASSPATH%" examples.App %*
