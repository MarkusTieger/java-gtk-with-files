...
class JnaFilenameCompleterClass {

    @FunctionalInterface
    public interface OnGotCompletionData extends com.sun.jna.Callback {
        void invoke(long filename_completer);
    }
    ...
    public static long allocateStructure() {
        if (_size < 0) {
            ...
            System.out.println("FilenameCompleterClass size: " + _size + " bytes");
        }
        return ch.bailu.gtk.lib.jna.CLib.allocate(_size);
    }
    
    @com.sun.jna.Structure.FieldOrder({FilenameCompleterClass.PARENT_CLASS, FilenameCompleterClass.GOT_COMPLETION_DATA, FilenameCompleterClass._G_RESERVED1, FilenameCompleterClass._G_RESERVED2, FilenameCompleterClass._G_RESERVED3})
    public static class Fields extends com.sun.jna.Structure {
        ...
        public OnGotCompletionData got_completion_data;
