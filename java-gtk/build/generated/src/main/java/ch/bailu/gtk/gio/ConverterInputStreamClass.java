...
/**
 * 
 * <p><a href="https://docs.gtk.org/gio/struct.ConverterInputStreamClass.html">https://docs.gtk.org/gio/struct.ConverterInputStreamClass.html</a></p>
*/
public class ConverterInputStreamClass extends ch.bailu.gtk.type.Record {
    public static ch.bailu.gtk.lib.handler.ClassHandler getClassHandler() {
        return ch.bailu.gtk.lib.handler.ClassHandler.get(ConverterInputStreamClass.class.getCanonicalName());
    }
    ...
    private static JnaConverterInputStreamClass.OnGReserved1 toOnGReserved1(ch.bailu.gtk.type.Pointer instance, String methodName, OnGReserved1 in) {
        JnaConverterInputStreamClass.OnGReserved1 out = null;
        if (in != null) {
    ...
    private static JnaConverterInputStreamClass.OnGReserved2 toOnGReserved2(ch.bailu.gtk.type.Pointer instance, String methodName, OnGReserved2 in) {
        JnaConverterInputStreamClass.OnGReserved2 out = null;
        if (in != null) {
            ch.bailu.gtk.lib.handler.CallbackHandler __callback = new ch.bailu.gtk.lib.handler.CallbackHandler(instance, methodName);
    ...
    private static JnaConverterInputStreamClass.OnGReserved3 toOnGReserved3(ch.bailu.gtk.type.Pointer instance, String methodName, OnGReserved3 in) {
        JnaConverterInputStreamClass.OnGReserved3 out = null;
        if (in != null) {
            ch.bailu.gtk.lib.handler.CallbackHandler __callback = new ch.bailu.gtk.lib.handler.CallbackHandler(instance, methodName);
    ...
    private static JnaConverterInputStreamClass.OnGReserved4 toOnGReserved4(ch.bailu.gtk.type.Pointer instance, String methodName, OnGReserved4 in) {
        JnaConverterInputStreamClass.OnGReserved4 out = null;
        if (in != null) {
            ch.bailu.gtk.lib.handler.CallbackHandler __callback = new ch.bailu.gtk.lib.handler.CallbackHandler(instance, methodName);
    ...
    private static JnaConverterInputStreamClass.OnGReserved5 toOnGReserved5(ch.bailu.gtk.type.Pointer instance, String methodName, OnGReserved5 in) {
        JnaConverterInputStreamClass.OnGReserved5 out = null;
        if (in != null) {
            ch.bailu.gtk.lib.handler.CallbackHandler __callback = new ch.bailu.gtk.lib.handler.CallbackHandler(instance, methodName);
    ...
    public ConverterInputStreamClass(PointerContainer pointer) {
        super(pointer);
    }

    public ConverterInputStreamClass() {
        super(cast(JnaConverterInputStreamClass.allocateStructure()));
    }

    private JnaConverterInputStreamClass.Fields _fields;
    
    JnaConverterInputStreamClass.Fields toFields() {
        if (_fields == null) {
            _fields = new JnaConverterInputStreamClass.Fields(asCPointer());
        }
        return _fields;
    }
    ...
    */
     ...
     * <br>See {@link OnGReserved1#onGReserved1}
    */
    public JnaConverterInputStreamClass.OnGReserved1 getFieldGReserved1() {
    ...
    */
     ...
     * <br>See {@link OnGReserved2#onGReserved2}
    */
    public JnaConverterInputStreamClass.OnGReserved2 getFieldGReserved2() {
    ...
    */
     ...
     * <br>See {@link OnGReserved3#onGReserved3}
    */
    public JnaConverterInputStreamClass.OnGReserved3 getFieldGReserved3() {
    ...
    */
     ...
     * <br>See {@link OnGReserved4#onGReserved4}
    */
    public JnaConverterInputStreamClass.OnGReserved4 getFieldGReserved4() {
    ...
    */
     ...
     * <br>See {@link OnGReserved5#onGReserved5}
    */
    public JnaConverterInputStreamClass.OnGReserved5 getFieldGReserved5() {
       toFields().readField(_G_RESERVED5);
       return toFields()._g_reserved5;
    } 

    public static ch.bailu.gtk.type.gobject.TypeSystem.TypeSize getTypeSize() {
        return ch.bailu.gtk.type.gobject.TypeSystem.getTypeSize(ConverterInputStream.getTypeID());
    }
    
    public static ch.bailu.gtk.type.gobject.TypeSystem.TypeSize getParentTypeSize() {
        return ch.bailu.gtk.type.gobject.TypeSystem.getTypeSize(ConverterInputStream.getParentTypeID());
    }
