...
class JnaConverterOutputStreamClass {
    ...
    public static long allocateStructure() {
        if (_size < 0) {
            ...
            System.out.println("ConverterOutputStreamClass size: " + _size + " bytes");
        }
        return ch.bailu.gtk.lib.jna.CLib.allocate(_size);
    }
    
    @com.sun.jna.Structure.FieldOrder({ConverterOutputStreamClass.PARENT_CLASS, ConverterOutputStreamClass._G_RESERVED1, ConverterOutputStreamClass._G_RESERVED2, ConverterOutputStreamClass._G_RESERVED3, ConverterOutputStreamClass._G_RESERVED4, ConverterOutputStreamClass._G_RESERVED5})
    public static class Fields extends com.sun.jna.Structure {
        ...
        public byte[] parent_class = new byte[FilterOutputStreamClass.getInstanceSize()];
