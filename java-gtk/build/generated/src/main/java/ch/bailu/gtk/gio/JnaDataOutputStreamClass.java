...
class JnaDataOutputStreamClass {
    ...
    public static long allocateStructure() {
        if (_size < 0) {
            ...
            System.out.println("DataOutputStreamClass size: " + _size + " bytes");
        }
        return ch.bailu.gtk.lib.jna.CLib.allocate(_size);
    }
    
    @com.sun.jna.Structure.FieldOrder({DataOutputStreamClass.PARENT_CLASS, DataOutputStreamClass._G_RESERVED1, DataOutputStreamClass._G_RESERVED2, DataOutputStreamClass._G_RESERVED3, DataOutputStreamClass._G_RESERVED4, DataOutputStreamClass._G_RESERVED5})
