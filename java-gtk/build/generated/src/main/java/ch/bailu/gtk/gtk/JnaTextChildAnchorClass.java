...
class JnaTextChildAnchorClass {
    ...
    public static long allocateStructure() {
        if (_size < 0) {
            ...
            System.out.println("TextChildAnchorClass size: " + _size + " bytes");
        }
        return ch.bailu.gtk.lib.jna.CLib.allocate(_size);
    }
    
    @com.sun.jna.Structure.FieldOrder({TextChildAnchorClass.PARENT_CLASS, TextChildAnchorClass._GTK_RESERVED1, TextChildAnchorClass._GTK_RESERVED2, TextChildAnchorClass._GTK_RESERVED3, TextChildAnchorClass._GTK_RESERVED4})
