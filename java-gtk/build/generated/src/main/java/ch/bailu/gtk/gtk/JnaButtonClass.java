...
class JnaButtonClass {
    ...
    public static long allocateStructure() {
        if (_size < 0) {
            ...
            System.out.println("ButtonClass size: " + _size + " bytes");
        }
        return ch.bailu.gtk.lib.jna.CLib.allocate(_size);
    }
    
    @com.sun.jna.Structure.FieldOrder({ButtonClass.PARENT_CLASS, ButtonClass.CLICKED, ButtonClass.ACTIVATE})
