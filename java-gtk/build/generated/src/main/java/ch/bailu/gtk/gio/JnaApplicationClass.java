...
class JnaApplicationClass {
    ...
    @com.sun.jna.Structure.FieldOrder({ApplicationClass.PARENT_CLASS, ApplicationClass.STARTUP, ApplicationClass.ACTIVATE})
