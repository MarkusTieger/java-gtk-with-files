...
class JnaSimpleProxyResolverClass {
    ...
    public static long allocateStructure() {
        if (_size < 0) {
            ...
            System.out.println("SimpleProxyResolverClass size: " + _size + " bytes");
        }
        return ch.bailu.gtk.lib.jna.CLib.allocate(_size);
    }
    
    @com.sun.jna.Structure.FieldOrder({SimpleProxyResolverClass.PARENT_CLASS, SimpleProxyResolverClass._G_RESERVED1, SimpleProxyResolverClass._G_RESERVED2, SimpleProxyResolverClass._G_RESERVED3, SimpleProxyResolverClass._G_RESERVED4, SimpleProxyResolverClass._G_RESERVED5})
