...
class JnaConverterInputStreamClass {
    ...
    public static long allocateStructure() {
        if (_size < 0) {
            ...
            System.out.println("ConverterInputStreamClass size: " + _size + " bytes");
        }
        return ch.bailu.gtk.lib.jna.CLib.allocate(_size);
    }
    
    @com.sun.jna.Structure.FieldOrder({ConverterInputStreamClass.PARENT_CLASS, ConverterInputStreamClass._G_RESERVED1, ConverterInputStreamClass._G_RESERVED2, ConverterInputStreamClass._G_RESERVED3, ConverterInputStreamClass._G_RESERVED4, ConverterInputStreamClass._G_RESERVED5})
