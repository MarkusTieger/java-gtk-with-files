...
class JnaWindowGroupClass {
    ...
    public static long allocateStructure() {
        if (_size < 0) {
            ...
            System.out.println("WindowGroupClass size: " + _size + " bytes");
        }
        return ch.bailu.gtk.lib.jna.CLib.allocate(_size);
    }
    
    @com.sun.jna.Structure.FieldOrder({WindowGroupClass.PARENT_CLASS, WindowGroupClass._GTK_RESERVED1, WindowGroupClass._GTK_RESERVED2, WindowGroupClass._GTK_RESERVED3, WindowGroupClass._GTK_RESERVED4})
