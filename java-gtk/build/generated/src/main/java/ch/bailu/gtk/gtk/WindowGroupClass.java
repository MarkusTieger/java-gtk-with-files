...
/**
 * 
 * <p><a href="https://docs.gtk.org/gtk4/struct.WindowGroupClass.html">https://docs.gtk.org/gtk4/struct.WindowGroupClass.html</a></p>
*/
public class WindowGroupClass extends ch.bailu.gtk.type.Record {
    public static ch.bailu.gtk.lib.handler.ClassHandler getClassHandler() {
        return ch.bailu.gtk.lib.handler.ClassHandler.get(WindowGroupClass.class.getCanonicalName());
    }
    ...
    private static JnaWindowGroupClass.OnGtkReserved1 toOnGtkReserved1(ch.bailu.gtk.type.Pointer instance, String methodName, OnGtkReserved1 in) {
        JnaWindowGroupClass.OnGtkReserved1 out = null;
        if (in != null) {
    ...
    private static JnaWindowGroupClass.OnGtkReserved2 toOnGtkReserved2(ch.bailu.gtk.type.Pointer instance, String methodName, OnGtkReserved2 in) {
        JnaWindowGroupClass.OnGtkReserved2 out = null;
        if (in != null) {
            ch.bailu.gtk.lib.handler.CallbackHandler __callback = new ch.bailu.gtk.lib.handler.CallbackHandler(instance, methodName);
    ...
    private static JnaWindowGroupClass.OnGtkReserved3 toOnGtkReserved3(ch.bailu.gtk.type.Pointer instance, String methodName, OnGtkReserved3 in) {
        JnaWindowGroupClass.OnGtkReserved3 out = null;
        if (in != null) {
            ch.bailu.gtk.lib.handler.CallbackHandler __callback = new ch.bailu.gtk.lib.handler.CallbackHandler(instance, methodName);
    ...
    private static JnaWindowGroupClass.OnGtkReserved4 toOnGtkReserved4(ch.bailu.gtk.type.Pointer instance, String methodName, OnGtkReserved4 in) {
        JnaWindowGroupClass.OnGtkReserved4 out = null;
        if (in != null) {
            ch.bailu.gtk.lib.handler.CallbackHandler __callback = new ch.bailu.gtk.lib.handler.CallbackHandler(instance, methodName);
    ...
    public WindowGroupClass(PointerContainer pointer) {
        super(pointer);
    }

    public WindowGroupClass() {
        super(cast(JnaWindowGroupClass.allocateStructure()));
    }

    private JnaWindowGroupClass.Fields _fields;
    
    JnaWindowGroupClass.Fields toFields() {
        if (_fields == null) {
            _fields = new JnaWindowGroupClass.Fields(asCPointer());
        }
        return _fields;
    }
    ...
    */
     ...
     * <br>See {@link OnGtkReserved1#onGtkReserved1}
    */
    public JnaWindowGroupClass.OnGtkReserved1 getFieldGtkReserved1() {
    ...
    */
     ...
     * <br>See {@link OnGtkReserved2#onGtkReserved2}
    */
    public JnaWindowGroupClass.OnGtkReserved2 getFieldGtkReserved2() {
    ...
    */
     ...
     * <br>See {@link OnGtkReserved3#onGtkReserved3}
    */
    public JnaWindowGroupClass.OnGtkReserved3 getFieldGtkReserved3() {
    ...
    */
     ...
     * <br>See {@link OnGtkReserved4#onGtkReserved4}
    */
    public JnaWindowGroupClass.OnGtkReserved4 getFieldGtkReserved4() {
       toFields().readField(_GTK_RESERVED4);
       return toFields()._gtk_reserved4;
    } 

    public static ch.bailu.gtk.type.gobject.TypeSystem.TypeSize getTypeSize() {
        return ch.bailu.gtk.type.gobject.TypeSystem.getTypeSize(WindowGroup.getTypeID());
    }
    
    public static ch.bailu.gtk.type.gobject.TypeSystem.TypeSize getParentTypeSize() {
        return ch.bailu.gtk.type.gobject.TypeSystem.getTypeSize(WindowGroup.getParentTypeID());
    }
