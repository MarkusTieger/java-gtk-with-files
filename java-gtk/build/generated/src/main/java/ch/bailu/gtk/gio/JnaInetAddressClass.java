...
class JnaInetAddressClass {
    ...
    public static long allocateStructure() {
        if (_size < 0) {
            ...
            System.out.println("InetAddressClass size: " + _size + " bytes");
        }
        return ch.bailu.gtk.lib.jna.CLib.allocate(_size);
    }
    
    @com.sun.jna.Structure.FieldOrder({InetAddressClass.PARENT_CLASS, InetAddressClass.TO_STRING})
