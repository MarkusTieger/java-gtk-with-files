 ...
 * <br>
 * <br>To add filters to a `GtkAnyFilter`, use [method&#64;Gtk.MultiFilter.append].
 * <p><a href="https://docs.gtk.org/gtk4/class.AnyFilter.html">https://docs.gtk.org/gtk4/class.AnyFilter.html</a></p>
*/
public class AnyFilter extends MultiFilter {
    public static ch.bailu.gtk.lib.handler.ClassHandler getClassHandler() {
        return ch.bailu.gtk.lib.handler.ClassHandler.get(AnyFilter.class.getCanonicalName());
    }
     ...
     * <br>
     * <br>This filter matches an item if any of the filters added to it
     * <br>matches the item. In particular, this means that if no filter
     * <br>has been added to it, the filter matches no item.
    */
    public AnyFilter() {
        super(cast(JnaAnyFilter.INST().gtk_any_filter_new()));
    }
    ...
    */
    ...
    public static long getTypeID() { 
        return JnaAnyFilter.INST().gtk_any_filter_get_type(); 
    }
