...
class JnaUnixFDMessageClass {
    ...
    public static long allocateStructure() {
        if (_size < 0) {
            ...
            System.out.println("UnixFDMessageClass size: " + _size + " bytes");
        }
        return ch.bailu.gtk.lib.jna.CLib.allocate(_size);
    }
    
    @com.sun.jna.Structure.FieldOrder({UnixFDMessageClass.PARENT_CLASS, UnixFDMessageClass._G_RESERVED1, UnixFDMessageClass._G_RESERVED2})
