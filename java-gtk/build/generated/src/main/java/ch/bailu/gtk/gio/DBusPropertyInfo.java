 ...
 * <p><a href="https://docs.gtk.org/gio/struct.DBusPropertyInfo.html">https://docs.gtk.org/gio/struct.DBusPropertyInfo.html</a></p>
*/
public class DBusPropertyInfo extends ch.bailu.gtk.type.Record {
    public static ch.bailu.gtk.lib.handler.ClassHandler getClassHandler() {
        return ch.bailu.gtk.lib.handler.ClassHandler.get(DBusPropertyInfo.class.getCanonicalName());
    }

    public DBusPropertyInfo(PointerContainer pointer) {
        super(pointer);
    }

    private JnaDBusPropertyInfo.Fields _fields;
    
    JnaDBusPropertyInfo.Fields toFields() {
        if (_fields == null) {
            _fields = new JnaDBusPropertyInfo.Fields(asCPointer());
        }
        return _fields;
    }
    ...
    */
     ...
     * The D-Bus signature of the property (a single complete type).
    */
    public void setFieldSignature(ch.bailu.gtk.type.Str signature) {
     ...
     * The D-Bus signature of the property (a single complete type).
    */
    public ch.bailu.gtk.type.Str getFieldSignature() {
       toFields().readField(SIGNATURE);
       return new ch.bailu.gtk.type.Str(new PointerContainer(toFields().signature));
    } 
    ...
    */
    public DBusPropertyInfo ref()  {
        return new DBusPropertyInfo(new PointerContainer(JnaDBusPropertyInfo.INST().g_dbus_property_info_ref(asCPointer())));
    }
    ...
    */
    public void unref()  {
        JnaDBusPropertyInfo.INST().g_dbus_property_info_unref(asCPointer());
    }

    public static long getTypeID() { 
        return JnaDBusPropertyInfo.INST().g_dbus_property_info_get_type(); 
    }
