...
class JnaAdjustmentClass {
    ...
    public static long allocateStructure() {
        if (_size < 0) {
            ...
            System.out.println("AdjustmentClass size: " + _size + " bytes");
        }
        return ch.bailu.gtk.lib.jna.CLib.allocate(_size);
    }
    
    @com.sun.jna.Structure.FieldOrder({AdjustmentClass.PARENT_CLASS, AdjustmentClass.CHANGED, AdjustmentClass.VALUE_CHANGED, AdjustmentClass._GTK_RESERVED1, AdjustmentClass._GTK_RESERVED2, AdjustmentClass._GTK_RESERVED3, AdjustmentClass._GTK_RESERVED4})
