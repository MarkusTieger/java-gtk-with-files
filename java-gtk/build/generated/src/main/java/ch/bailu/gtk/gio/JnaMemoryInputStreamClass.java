...
class JnaMemoryInputStreamClass {
    ...
    public static long allocateStructure() {
        if (_size < 0) {
            ...
            System.out.println("MemoryInputStreamClass size: " + _size + " bytes");
        }
        return ch.bailu.gtk.lib.jna.CLib.allocate(_size);
    }
    
    @com.sun.jna.Structure.FieldOrder({MemoryInputStreamClass.PARENT_CLASS, MemoryInputStreamClass._G_RESERVED1, MemoryInputStreamClass._G_RESERVED2, MemoryInputStreamClass._G_RESERVED3, MemoryInputStreamClass._G_RESERVED4, MemoryInputStreamClass._G_RESERVED5})
    public static class Fields extends com.sun.jna.Structure {
        ...
        public byte[] parent_class = new byte[InputStreamClass.getInstanceSize()];
