...
/**
 * 
 * <p><a href="https://docs.gtk.org/gio/struct.MemoryOutputStreamClass.html">https://docs.gtk.org/gio/struct.MemoryOutputStreamClass.html</a></p>
*/
public class MemoryOutputStreamClass extends ch.bailu.gtk.type.Record {
    public static ch.bailu.gtk.lib.handler.ClassHandler getClassHandler() {
        return ch.bailu.gtk.lib.handler.ClassHandler.get(MemoryOutputStreamClass.class.getCanonicalName());
    }
    ...
    private static JnaMemoryOutputStreamClass.OnGReserved1 toOnGReserved1(ch.bailu.gtk.type.Pointer instance, String methodName, OnGReserved1 in) {
        JnaMemoryOutputStreamClass.OnGReserved1 out = null;
        if (in != null) {
    ...
    private static JnaMemoryOutputStreamClass.OnGReserved2 toOnGReserved2(ch.bailu.gtk.type.Pointer instance, String methodName, OnGReserved2 in) {
        JnaMemoryOutputStreamClass.OnGReserved2 out = null;
        if (in != null) {
            ch.bailu.gtk.lib.handler.CallbackHandler __callback = new ch.bailu.gtk.lib.handler.CallbackHandler(instance, methodName);
    ...
    private static JnaMemoryOutputStreamClass.OnGReserved3 toOnGReserved3(ch.bailu.gtk.type.Pointer instance, String methodName, OnGReserved3 in) {
        JnaMemoryOutputStreamClass.OnGReserved3 out = null;
        if (in != null) {
            ch.bailu.gtk.lib.handler.CallbackHandler __callback = new ch.bailu.gtk.lib.handler.CallbackHandler(instance, methodName);
    ...
    private static JnaMemoryOutputStreamClass.OnGReserved4 toOnGReserved4(ch.bailu.gtk.type.Pointer instance, String methodName, OnGReserved4 in) {
        JnaMemoryOutputStreamClass.OnGReserved4 out = null;
        if (in != null) {
            ch.bailu.gtk.lib.handler.CallbackHandler __callback = new ch.bailu.gtk.lib.handler.CallbackHandler(instance, methodName);
    ...
    private static JnaMemoryOutputStreamClass.OnGReserved5 toOnGReserved5(ch.bailu.gtk.type.Pointer instance, String methodName, OnGReserved5 in) {
        JnaMemoryOutputStreamClass.OnGReserved5 out = null;
        if (in != null) {
            ch.bailu.gtk.lib.handler.CallbackHandler __callback = new ch.bailu.gtk.lib.handler.CallbackHandler(instance, methodName);
    ...
    public MemoryOutputStreamClass(PointerContainer pointer) {
        super(pointer);
    }

    public MemoryOutputStreamClass() {
        super(cast(JnaMemoryOutputStreamClass.allocateStructure()));
    }

    private JnaMemoryOutputStreamClass.Fields _fields;
    
    JnaMemoryOutputStreamClass.Fields toFields() {
        if (_fields == null) {
            _fields = new JnaMemoryOutputStreamClass.Fields(asCPointer());
        }
        return _fields;
    }
    ...
    */
     ...
     * <br>See {@link OnGReserved1#onGReserved1}
    */
    public JnaMemoryOutputStreamClass.OnGReserved1 getFieldGReserved1() {
    ...
    */
     ...
     * <br>See {@link OnGReserved2#onGReserved2}
    */
    public JnaMemoryOutputStreamClass.OnGReserved2 getFieldGReserved2() {
    ...
    */
     ...
     * <br>See {@link OnGReserved3#onGReserved3}
    */
    public JnaMemoryOutputStreamClass.OnGReserved3 getFieldGReserved3() {
    ...
    */
     ...
     * <br>See {@link OnGReserved4#onGReserved4}
    */
    public JnaMemoryOutputStreamClass.OnGReserved4 getFieldGReserved4() {
    ...
    */
     ...
     * <br>See {@link OnGReserved5#onGReserved5}
    */
    public JnaMemoryOutputStreamClass.OnGReserved5 getFieldGReserved5() {
       toFields().readField(_G_RESERVED5);
       return toFields()._g_reserved5;
    } 

    public static ch.bailu.gtk.type.gobject.TypeSystem.TypeSize getTypeSize() {
        return ch.bailu.gtk.type.gobject.TypeSystem.getTypeSize(MemoryOutputStream.getTypeID());
    }
    
    public static ch.bailu.gtk.type.gobject.TypeSystem.TypeSize getParentTypeSize() {
        return ch.bailu.gtk.type.gobject.TypeSystem.getTypeSize(MemoryOutputStream.getParentTypeID());
    }
