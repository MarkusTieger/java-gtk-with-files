...
/**
 * 
 * <p><a href="https://docs.gtk.org/gio/struct.MemoryInputStreamClass.html">https://docs.gtk.org/gio/struct.MemoryInputStreamClass.html</a></p>
*/
public class MemoryInputStreamClass extends ch.bailu.gtk.type.Record {
    public static ch.bailu.gtk.lib.handler.ClassHandler getClassHandler() {
        return ch.bailu.gtk.lib.handler.ClassHandler.get(MemoryInputStreamClass.class.getCanonicalName());
    }
    ...
    private static JnaMemoryInputStreamClass.OnGReserved1 toOnGReserved1(ch.bailu.gtk.type.Pointer instance, String methodName, OnGReserved1 in) {
        JnaMemoryInputStreamClass.OnGReserved1 out = null;
        if (in != null) {
    ...
    private static JnaMemoryInputStreamClass.OnGReserved2 toOnGReserved2(ch.bailu.gtk.type.Pointer instance, String methodName, OnGReserved2 in) {
        JnaMemoryInputStreamClass.OnGReserved2 out = null;
        if (in != null) {
            ch.bailu.gtk.lib.handler.CallbackHandler __callback = new ch.bailu.gtk.lib.handler.CallbackHandler(instance, methodName);
    ...
    private static JnaMemoryInputStreamClass.OnGReserved3 toOnGReserved3(ch.bailu.gtk.type.Pointer instance, String methodName, OnGReserved3 in) {
        JnaMemoryInputStreamClass.OnGReserved3 out = null;
        if (in != null) {
            ch.bailu.gtk.lib.handler.CallbackHandler __callback = new ch.bailu.gtk.lib.handler.CallbackHandler(instance, methodName);
    ...
    private static JnaMemoryInputStreamClass.OnGReserved4 toOnGReserved4(ch.bailu.gtk.type.Pointer instance, String methodName, OnGReserved4 in) {
        JnaMemoryInputStreamClass.OnGReserved4 out = null;
        if (in != null) {
            ch.bailu.gtk.lib.handler.CallbackHandler __callback = new ch.bailu.gtk.lib.handler.CallbackHandler(instance, methodName);
    ...
    private static JnaMemoryInputStreamClass.OnGReserved5 toOnGReserved5(ch.bailu.gtk.type.Pointer instance, String methodName, OnGReserved5 in) {
        JnaMemoryInputStreamClass.OnGReserved5 out = null;
        if (in != null) {
            ch.bailu.gtk.lib.handler.CallbackHandler __callback = new ch.bailu.gtk.lib.handler.CallbackHandler(instance, methodName);
    ...
    public MemoryInputStreamClass(PointerContainer pointer) {
        super(pointer);
    }

    public MemoryInputStreamClass() {
        super(cast(JnaMemoryInputStreamClass.allocateStructure()));
    }

    private JnaMemoryInputStreamClass.Fields _fields;
    
    JnaMemoryInputStreamClass.Fields toFields() {
        if (_fields == null) {
            _fields = new JnaMemoryInputStreamClass.Fields(asCPointer());
        }
        return _fields;
    }
    ...
    */
     ...
     * <br>See {@link OnGReserved1#onGReserved1}
    */
    public JnaMemoryInputStreamClass.OnGReserved1 getFieldGReserved1() {
    ...
    */
     ...
     * <br>See {@link OnGReserved2#onGReserved2}
    */
    public JnaMemoryInputStreamClass.OnGReserved2 getFieldGReserved2() {
    ...
    */
     ...
     * <br>See {@link OnGReserved3#onGReserved3}
    */
    public JnaMemoryInputStreamClass.OnGReserved3 getFieldGReserved3() {
    ...
    */
     ...
     * <br>See {@link OnGReserved4#onGReserved4}
    */
    public JnaMemoryInputStreamClass.OnGReserved4 getFieldGReserved4() {
    ...
    */
     ...
     * <br>See {@link OnGReserved5#onGReserved5}
    */
    public JnaMemoryInputStreamClass.OnGReserved5 getFieldGReserved5() {
       toFields().readField(_G_RESERVED5);
       return toFields()._g_reserved5;
    } 

    public static ch.bailu.gtk.type.gobject.TypeSystem.TypeSize getTypeSize() {
        return ch.bailu.gtk.type.gobject.TypeSystem.getTypeSize(MemoryInputStream.getTypeID());
    }
    
    public static ch.bailu.gtk.type.gobject.TypeSystem.TypeSize getParentTypeSize() {
        return ch.bailu.gtk.type.gobject.TypeSystem.getTypeSize(MemoryInputStream.getParentTypeID());
    }
