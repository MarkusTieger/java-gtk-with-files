...
class JnaUnixFDListClass {
    ...
    public static long allocateStructure() {
        if (_size < 0) {
            ...
            System.out.println("UnixFDListClass size: " + _size + " bytes");
        }
        return ch.bailu.gtk.lib.jna.CLib.allocate(_size);
    }
    
    @com.sun.jna.Structure.FieldOrder({UnixFDListClass.PARENT_CLASS, UnixFDListClass._G_RESERVED1, UnixFDListClass._G_RESERVED2, UnixFDListClass._G_RESERVED3, UnixFDListClass._G_RESERVED4, UnixFDListClass._G_RESERVED5})
