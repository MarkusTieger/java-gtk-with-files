...
/**
 * 
 * <p><a href="https://docs.gtk.org/gio/struct.FileOutputStreamClass.html">https://docs.gtk.org/gio/struct.FileOutputStreamClass.html</a></p>
*/
public class FileOutputStreamClass extends ch.bailu.gtk.type.Record {
    public static ch.bailu.gtk.lib.handler.ClassHandler getClassHandler() {
        return ch.bailu.gtk.lib.handler.ClassHandler.get(FileOutputStreamClass.class.getCanonicalName());
    }

    public FileOutputStreamClass(PointerContainer pointer) {
        super(pointer);
    }

    private JnaFileOutputStreamClass.Fields _fields;
    
    JnaFileOutputStreamClass.Fields toFields() {
        if (_fields == null) {
            _fields = new JnaFileOutputStreamClass.Fields(asCPointer());
        }
        return _fields;
    }
    ...
    */
    ...
    public static ch.bailu.gtk.type.gobject.TypeSystem.TypeSize getTypeSize() {
        return ch.bailu.gtk.type.gobject.TypeSystem.getTypeSize(FileOutputStream.getTypeID());
    }
    
    public static ch.bailu.gtk.type.gobject.TypeSystem.TypeSize getParentTypeSize() {
        return ch.bailu.gtk.type.gobject.TypeSystem.getTypeSize(FileOutputStream.getParentTypeID());
    }
...
[FieldModel:can_seek:previous-field-unsupported:[MethodModel:Supported:canSeek:[ParameterModel:Supported:{G_::{c:gboolean}}:{j:boolean}]]
        [ParameterModel:Supported:{Gg:FileOutputStream:{c:GFileOutputStream*}}:{j:long}]]
