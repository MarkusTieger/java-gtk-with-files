...
class JnaFilterClass {

    @FunctionalInterface
    public interface OnMatch extends com.sun.jna.Callback {
        boolean invoke(long self, long item);
    }

    @FunctionalInterface
    public interface OnGetStrictness extends com.sun.jna.Callback {
    ...
    public static long allocateStructure() {
        if (_size < 0) {
            ...
            System.out.println("FilterClass size: " + _size + " bytes");
        }
        return ch.bailu.gtk.lib.jna.CLib.allocate(_size);
    }
    
    @com.sun.jna.Structure.FieldOrder({FilterClass.PARENT_CLASS, FilterClass.MATCH, FilterClass.GET_STRICTNESS, FilterClass._GTK_RESERVED1, FilterClass._GTK_RESERVED2, FilterClass._GTK_RESERVED3, FilterClass._GTK_RESERVED4, FilterClass._GTK_RESERVED5, FilterClass._GTK_RESERVED6, FilterClass._GTK_RESERVED7, FilterClass._GTK_RESERVED8})
    public static class Fields extends com.sun.jna.Structure {
        ...
        public OnGetStrictness get_strictness;
