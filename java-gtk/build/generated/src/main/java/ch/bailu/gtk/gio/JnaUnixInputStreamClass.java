...
class JnaUnixInputStreamClass {
    ...
    public static long allocateStructure() {
        if (_size < 0) {
            ...
            System.out.println("UnixInputStreamClass size: " + _size + " bytes");
        }
        return ch.bailu.gtk.lib.jna.CLib.allocate(_size);
    }
    
    @com.sun.jna.Structure.FieldOrder({UnixInputStreamClass.PARENT_CLASS, UnixInputStreamClass._G_RESERVED1, UnixInputStreamClass._G_RESERVED2, UnixInputStreamClass._G_RESERVED3, UnixInputStreamClass._G_RESERVED4, UnixInputStreamClass._G_RESERVED5})
