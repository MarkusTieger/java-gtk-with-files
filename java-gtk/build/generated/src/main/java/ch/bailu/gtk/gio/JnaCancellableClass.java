...
class JnaCancellableClass {
    ...
    public static long allocateStructure() {
        if (_size < 0) {
            ...
            System.out.println("CancellableClass size: " + _size + " bytes");
        }
        return ch.bailu.gtk.lib.jna.CLib.allocate(_size);
    }
    
    @com.sun.jna.Structure.FieldOrder({CancellableClass.PARENT_CLASS, CancellableClass.CANCELLED, CancellableClass._G_RESERVED1, CancellableClass._G_RESERVED2, CancellableClass._G_RESERVED3, CancellableClass._G_RESERVED4, CancellableClass._G_RESERVED5})
