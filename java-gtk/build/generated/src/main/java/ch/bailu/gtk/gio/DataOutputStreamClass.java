...
/**
 * 
 * <p><a href="https://docs.gtk.org/gio/struct.DataOutputStreamClass.html">https://docs.gtk.org/gio/struct.DataOutputStreamClass.html</a></p>
*/
public class DataOutputStreamClass extends ch.bailu.gtk.type.Record {
    public static ch.bailu.gtk.lib.handler.ClassHandler getClassHandler() {
        return ch.bailu.gtk.lib.handler.ClassHandler.get(DataOutputStreamClass.class.getCanonicalName());
    }
    ...
    private static JnaDataOutputStreamClass.OnGReserved1 toOnGReserved1(ch.bailu.gtk.type.Pointer instance, String methodName, OnGReserved1 in) {
        JnaDataOutputStreamClass.OnGReserved1 out = null;
        if (in != null) {
    ...
    private static JnaDataOutputStreamClass.OnGReserved2 toOnGReserved2(ch.bailu.gtk.type.Pointer instance, String methodName, OnGReserved2 in) {
        JnaDataOutputStreamClass.OnGReserved2 out = null;
        if (in != null) {
            ch.bailu.gtk.lib.handler.CallbackHandler __callback = new ch.bailu.gtk.lib.handler.CallbackHandler(instance, methodName);
    ...
    private static JnaDataOutputStreamClass.OnGReserved3 toOnGReserved3(ch.bailu.gtk.type.Pointer instance, String methodName, OnGReserved3 in) {
        JnaDataOutputStreamClass.OnGReserved3 out = null;
        if (in != null) {
            ch.bailu.gtk.lib.handler.CallbackHandler __callback = new ch.bailu.gtk.lib.handler.CallbackHandler(instance, methodName);
    ...
    private static JnaDataOutputStreamClass.OnGReserved4 toOnGReserved4(ch.bailu.gtk.type.Pointer instance, String methodName, OnGReserved4 in) {
        JnaDataOutputStreamClass.OnGReserved4 out = null;
        if (in != null) {
            ch.bailu.gtk.lib.handler.CallbackHandler __callback = new ch.bailu.gtk.lib.handler.CallbackHandler(instance, methodName);
    ...
    private static JnaDataOutputStreamClass.OnGReserved5 toOnGReserved5(ch.bailu.gtk.type.Pointer instance, String methodName, OnGReserved5 in) {
        JnaDataOutputStreamClass.OnGReserved5 out = null;
        if (in != null) {
            ch.bailu.gtk.lib.handler.CallbackHandler __callback = new ch.bailu.gtk.lib.handler.CallbackHandler(instance, methodName);
    ...
    public DataOutputStreamClass(PointerContainer pointer) {
        super(pointer);
    }

    public DataOutputStreamClass() {
        super(cast(JnaDataOutputStreamClass.allocateStructure()));
    }

    private JnaDataOutputStreamClass.Fields _fields;
    
    JnaDataOutputStreamClass.Fields toFields() {
        if (_fields == null) {
            _fields = new JnaDataOutputStreamClass.Fields(asCPointer());
        }
        return _fields;
    }
    ...
    */
     ...
     * <br>See {@link OnGReserved1#onGReserved1}
    */
    public JnaDataOutputStreamClass.OnGReserved1 getFieldGReserved1() {
    ...
    */
     ...
     * <br>See {@link OnGReserved2#onGReserved2}
    */
    public JnaDataOutputStreamClass.OnGReserved2 getFieldGReserved2() {
    ...
    */
     ...
     * <br>See {@link OnGReserved3#onGReserved3}
    */
    public JnaDataOutputStreamClass.OnGReserved3 getFieldGReserved3() {
    ...
    */
     ...
     * <br>See {@link OnGReserved4#onGReserved4}
    */
    public JnaDataOutputStreamClass.OnGReserved4 getFieldGReserved4() {
    ...
    */
     ...
     * <br>See {@link OnGReserved5#onGReserved5}
    */
    public JnaDataOutputStreamClass.OnGReserved5 getFieldGReserved5() {
       toFields().readField(_G_RESERVED5);
       return toFields()._g_reserved5;
    } 

    public static ch.bailu.gtk.type.gobject.TypeSystem.TypeSize getTypeSize() {
        return ch.bailu.gtk.type.gobject.TypeSystem.getTypeSize(DataOutputStream.getTypeID());
    }
    
    public static ch.bailu.gtk.type.gobject.TypeSystem.TypeSize getParentTypeSize() {
        return ch.bailu.gtk.type.gobject.TypeSystem.getTypeSize(DataOutputStream.getParentTypeID());
    }
