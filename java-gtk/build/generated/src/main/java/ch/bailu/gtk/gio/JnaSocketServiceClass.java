...
class JnaSocketServiceClass {

    @FunctionalInterface
    public interface OnIncoming extends com.sun.jna.Callback {
        boolean invoke(long service, long connection, long source_object);
    }
    ...
    public static long allocateStructure() {
        if (_size < 0) {
            ...
            System.out.println("SocketServiceClass size: " + _size + " bytes");
        }
        return ch.bailu.gtk.lib.jna.CLib.allocate(_size);
    }
    
    @com.sun.jna.Structure.FieldOrder({SocketServiceClass.PARENT_CLASS, SocketServiceClass.INCOMING, SocketServiceClass._G_RESERVED1, SocketServiceClass._G_RESERVED2, SocketServiceClass._G_RESERVED3, SocketServiceClass._G_RESERVED4, SocketServiceClass._G_RESERVED5, SocketServiceClass._G_RESERVED6})
    public static class Fields extends com.sun.jna.Structure {
        ...
        public byte[] parent_class = new byte[SocketListenerClass.getInstanceSize()];
        public OnIncoming incoming;
