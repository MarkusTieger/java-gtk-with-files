...
class JnaUnixOutputStreamClass {
    ...
    public static long allocateStructure() {
        if (_size < 0) {
            ...
            System.out.println("UnixOutputStreamClass size: " + _size + " bytes");
        }
        return ch.bailu.gtk.lib.jna.CLib.allocate(_size);
    }
    
    @com.sun.jna.Structure.FieldOrder({UnixOutputStreamClass.PARENT_CLASS, UnixOutputStreamClass._G_RESERVED1, UnixOutputStreamClass._G_RESERVED2, UnixOutputStreamClass._G_RESERVED3, UnixOutputStreamClass._G_RESERVED4, UnixOutputStreamClass._G_RESERVED5})
