...
class JnaSocketClientClass {

    @FunctionalInterface
    public interface OnEvent extends com.sun.jna.Callback {
        void invoke(long client, int event, long connectable, long connection);
    }
    ...
    public static long allocateStructure() {
        if (_size < 0) {
            ...
            System.out.println("SocketClientClass size: " + _size + " bytes");
        }
        return ch.bailu.gtk.lib.jna.CLib.allocate(_size);
    }
    
    @com.sun.jna.Structure.FieldOrder({SocketClientClass.PARENT_CLASS, SocketClientClass.EVENT, SocketClientClass._G_RESERVED1, SocketClientClass._G_RESERVED2, SocketClientClass._G_RESERVED3, SocketClientClass._G_RESERVED4})
